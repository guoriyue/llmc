...
#include "lang-cli-src/config.h"
#include "lang-cli-src/file_manager.h"
#include "lang-cli-src/model_manager.h"
#include "lang-cli-src/console_manager.h"
#include "lang-cli-src/output_parser.h"
#include "lang-cli-src/shell_executor.h"
#include "lang-cli-src/str_parser.h"
...
int main(int argc, char ** argv) {
    ...
    if (params.model == DEFAULT_MODEL_PATH) {
        ...
        if (params.llmc_setup) {
            print_centered_message("Setting up LangCommand model", PRINT_LENGTH);
            ...
            print_centered_message("Model not found or invalid. Setting up LangCommand model", PRINT_LENGTH);
            params.model = mm.set_model();
        } else {
