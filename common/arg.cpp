...
static bool gpt_params_parse_ex(int argc, char ** argv, gpt_params_context & ctx_arg) {
        ...
        if (opt.get_value_from_env(value)) {
            try {
                if (opt.handler_void && (value == "1" || value == "true")) {
                    opt.handler_void(params, modified_args);
                }
                if (opt.handler_int) {
                    opt.handler_int(params, std::stoi(value), modified_args);
                }
                if (opt.handler_string) {
                    opt.handler_string(params, value, modified_args);
                    continue;
                }
    ...
    for (int i = argc_start_idx; i < argc; i++) {
        ...
        try {
            ...
            if (opt.handler_int) {
                opt.handler_int(params, std::stoi(val), modified_args);
                continue;
            }
            if (opt.handler_string) {
                opt.handler_string(params, val, modified_args);
                continue;
            }
            ...
            if (opt.handler_str_str) {
                opt.handler_str_str(params, val, val2, modified_args);
                continue;
            }
        } catch (std::exception & e) {
            throw std::invalid_argument(format(
...
gpt_params_context gpt_params_parser_init(gpt_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params &, std::unordered_map<std::string, std::string> &modified_args) {
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params & params, std::unordered_map<std::string, std::string> &modified_args) {
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params & params, int value, std::unordered_map<std::string, std::string> &modified_args) {
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params & params, const std::string & mask, std::unordered_map<std::string, std::string> &modified_args) {
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params & params, const std::string & range, std::unordered_map<std::string, std::string> &modified_args) {
            params.cpuparams.mask_valid = true;
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params & params, const std::string & value, std::unordered_map<std::string, std::string> &modified_args) {
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params & params, int prio, std::unordered_map<std::string, std::string> &modified_args) {
            if (prio < 0 || prio > 3) {
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params & params, const std::string & fname, const std::string & scale, std::unordered_map<std::string, std::string> &modified_args) {
    ...
    add_opt(llama_arg(
        ...
        [](gpt_params & params, const std::string & start, const std::string & end, std::unordered_map<std::string, std::string> &modified_args) {
    ...
    add_opt(llama_arg(
        {"--log-file"}, "FNAME",
        "Log to file",
        [](gpt_params &, const std::string & value, std::unordered_map<std::string, std::string> &modified_args) {
